...
RESOURCES += src/qt/mxdum.qrc src/qt/mxdum_locale.qrc

TRANSLATIONS += src/qt/locale/mxdum_bg.ts \
                src/qt/locale/mxdum_de.ts \
                src/qt/locale/mxdum_en.ts \
                src/qt/locale/mxdum_es.ts \
                src/qt/locale/mxdum_fi.ts \
                src/qt/locale/mxdum_fr.ts \
                src/qt/locale/mxdum_it.ts \
                src/qt/locale/mxdum_ja.ts \
                src/qt/locale/mxdum_pl.ts \
                src/qt/locale/mxdum_pt.ts \
                src/qt/locale/mxdum_ru.ts \
                src/qt/locale/mxdum_sk.ts \
                src/qt/locale/mxdum_sv.ts \
                src/qt/locale/mxdum_vi.ts \
                src/qt/locale/mxdum_zh_CN.ts \
                src/qt/locale/mxdum_zh_TW.ts
