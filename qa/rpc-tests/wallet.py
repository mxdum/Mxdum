...
#   c) node1 mines 32 blocks, so now node 0 has 60001mdm, node 1 has 4250mdm, node2 has none.
#   d) node0 sends 601 mdm to node2, in two transactions (301 mdm, then 300 mdm).
