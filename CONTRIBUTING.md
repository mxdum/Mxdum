Contributing to Mxdum Core
============================

The Mxdum Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mxdum Core project, and is not to be
confused with overall Mxdum Network Protocol consensus changes.

Whether a pull request is merged into Mxdum Core rests with the project merge
...
Patches that change Mxdum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mxdum consensus, it must have been
...
The project leader is the release manager for each Mxdum Core release.
