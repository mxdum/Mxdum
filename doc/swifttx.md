...
This mechanism has been integrated into Bitcore-Node-Mxdum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Mxdum-Project/insight-api-mxdum#web-socket-api](https://github.com/Mxdum-Project/insight-api-mxdum#web-socket-api) 
* API: [https://github.com/Mxdum-Project/insight-api-mxdum#swifttx-transactions](https://github.com/Mxdum-Project/insight-api-mxdum#swifttx-transactions) 
...
By default, the Mxdum Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mxdum Core daemon:
