...
In order to support loading of multiple wallets in mxdum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mxdum.cpp.
...
Changes to mxdum.cpp
----------------------
mxdum.cpp is the entry point into mxdum-qt, and as such, will require some minor modifications to provide hooks for
