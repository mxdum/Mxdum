...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mxdum features */
        {"mxdum", "masternode", &masternode, true, true, false},
        {"mxdum", "listmasternodes", &listmasternodes, true, true, false},
        {"mxdum", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mxdum", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mxdum", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mxdum", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mxdum", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mxdum", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mxdum", "masternodedebug", &masternodedebug, true, true, false},
        {"mxdum", "startmasternode", &startmasternode, true, true, false},
        {"mxdum", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mxdum", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mxdum", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mxdum", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mxdum", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mxdum", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mxdum", "mnbudget", &mnbudget, true, true, false},
        {"mxdum", "preparebudget", &preparebudget, true, true, false},
        {"mxdum", "submitbudget", &submitbudget, true, true, false},
        {"mxdum", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mxdum", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mxdum", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mxdum", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mxdum", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mxdum", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mxdum", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mxdum", "checkbudgets", &checkbudgets, true, true, false},
        {"mxdum", "mnsync", &mnsync, true, true, false},
        {"mxdum", "spork", &spork, true, true, false},
        {"mxdum", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmdmseed", &getzmdmseed, false, false, true},
        {"zerocoin", "setzmdmseed", &setzmdmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmdm", &searchdzmdm, false, false, true},
        {"zerocoin", "dzmdmstate", &dzmdmstate, false, false, true}
...
{
    return "> mxdum-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6393/\n";
}
