...
#ifndef Mxdum_STAKEINPUT_H
#define Mxdum_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZMDM() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zMDMStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zmdm, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZMDM() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZMDM() override { return false; }
};


#endif //Mxdum_STAKEINPUT_H
