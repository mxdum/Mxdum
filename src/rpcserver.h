...
extern UniValue setzmdmseed(const UniValue& params, bool fHelp);
extern UniValue getzmdmseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmdm(const UniValue& params, bool fHelp);
extern UniValue dzmdmstate(const UniValue& params, bool fHelp);
