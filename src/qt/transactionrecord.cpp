...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zmdmTracker->HasMintTx(hash))) {
            //zMDM stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZMDM;
...
bool IsZMDMType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZMDM:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZMDM || type == TransactionRecord::MNReward) {
