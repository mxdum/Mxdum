                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMDMPathCustom = GetArg("-zmdmbackuppath", "");
    ...
    if(!strzMDMPathCustom.empty()) {
        ui->wallet_customzmdmbackuppath->setText(QString::fromStdString(strzMDMPathCustom));
        ui->wallet_customzmdmbackuppath_label->setVisible(true);
        ui->wallet_customzmdmbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMDMPathCustom.empty()) && nCustomBackupThreshold > 0) {
