...
/* Mxdum GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Mxdum"
#define QAPP_ORG_DOMAIN "mxdum.org"
#define QAPP_APP_NAME_DEFAULT "Mxdum-Qt"
#define QAPP_APP_NAME_TESTNET "Mxdum-Qt-testnet"
