                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mxdum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mxdum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mxdum: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMDM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mxdum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mxdum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mxdum"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mxdum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mxdum addresses"));
    ...
    openAction->setStatusTip(tr("Open a Mxdum: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mxdum Core help message to get a list with possible Mxdum command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mxdum Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Mxdum Core"); // default title
