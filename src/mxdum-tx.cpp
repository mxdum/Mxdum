...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mxdum Core mxdum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mxdum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mxdum transaction") + "\n" +
                               "  mxdum-tx [options] -create [commands]   " + _("Create hex-encoded mxdum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mxdum transaction
